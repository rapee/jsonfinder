...
(function(e){var t=e.event,n=t.special.drag,r=n.add,i=n.teardown;n.noBubble=!1;n.livekey="livedrag";n.add=function(i){r.apply(this,arguments);var s=e.data(this,n.datakey);if(!s.live&&i.selector){s.live=!0;t.add(this,"draginit."+n.livekey,n.delegate)}};n.teardown=function(){i.apply(this,arguments);var r=e.data(this,n.datakey)||{};if(r.live){t.remove(this,"draginit."+n.livekey,n.delegate);r.live=!1}};n.delegate=function(r){var i=[],s,o=e.data(this,"events")||{};e.each(o||[],function(o,u){if(o.indexOf("drag")!==0)return;e.each(u||[],function(o,u){s=e(r.target).closest(u.selector,r.currentTarget)[0];if(!s)return;t.add(s,u.origType+"."+n.livekey,u.origHandler||u.handler,u.data);e.inArray(s,i)<0&&i.push(s)})});return i.length?e(i).bind("dragend."+n.livekey,function(){t.remove(this,"."+n.livekey)}):!1}})(jQuery);
...
(function() {
	...
	function jsonToFinderView(json) {
		var dom;
		var list;
		var resizer = $('<i class="resize-handler"></i>');
		...
		.on('drag', function(e, dd) {
			dom.css({ width: Math.max(0, _origin_w+dd.deltaX)+'px' });
		});
